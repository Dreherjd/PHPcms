...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=124500219ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=phpcms&table=users">`phpcms`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=phpcms&table=reviews">`phpcms`.`reviews`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=feedbackapp&table=feedback">`feedbackapp`.`feedback`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="592455743a5f245e6c3f2c7e3078356d">
    ...
    <div id="pma_console">
            ...
            Queried time
                            ...
                            <span class="query">/*!40101 SET COLLATION_CONNECTION=@OLD_COLLATION_CONNECTION */;</span>
                                            ...
                                            <div class="message history collapsed hide"
                            targetdb="phpcms" targettable="reviews">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `phpcms`.`reviews` ( `review_id` INT NOT NULL AUTO_INCREMENT ,  `review_title` VARCHAR(50) NOT NULL ,  `review_content` VARCHAR(500) NOT NULL ,    PRIMARY KEY  (`review_id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="phpcms" targettable="users">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
